...
const About = () => {
  ...
  return (
    <section id="why-raptortech" className="py-16 px-4 md:px-8 bg-gradient-to-br from-purple-100 via-blue-50 to-pink-50">
      <div className="max-w-7xl mx-auto">
        <div className="space-y-16">
          {/* Why RaptorTech Section */}
          <div className="text-center">
            ...
            <h2 className="text-4xl font-bold mb-4">Why RaptorTech?</h2>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <div className="space-y-4 text-slate-600">
                <p>
                  RaptorTech Recruitment was born from a passion for connecting great talent with
                  forward-thinking businesses. But before we placed our first candidate, there was one
                  unexpected challenge—choosing a name.
                </p>
                <p>
                  After weeks of brainstorming, RaptorTech was inspired by childhood ambition and a
                  lifelong love of dinosaurs. While "raptor" might mean "to seize" in Latin—fitting for a
                  recruitment agency that helps businesses secure top talent—the real story goes back to a
                  six-year-old's dream of becoming a paleontologist. That dream evolved, but the spirit
                  remains the same: curiosity, determination, and a relentless pursuit of the best.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4 text-slate-600">
                <p>
                  RaptorTech Recruitment is a specialist IT recruitment agency with deep-rooted networks
