      ...
      <div className="container mx-auto px-4">
        <div className="text-center">
          ...
          <h2 className="text-4xl font-bold text-center mb-8 text-slate-900">
            The RaptorTech Advantage: What You Gain
          </h2>
          
          <p className="text-center text-lg mb-12 max-w-3xl mx-auto text-slate-600">
            When you partner with <strong className="text-blue-600">RaptorTech Recruitment</strong>, you get more than just a job listing or a pile of resumes. 
